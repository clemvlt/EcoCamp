...
--
-- Hôte : db
-- Généré le : lun. 23 mars 2026 à 10:53
...
(1, 'Mobil-home  01', NULL),
(2, 'Mobil-home  02', 2),
(7, 'Mobil-home Azur 01', NULL),
(8, 'Mobil-home Azur 02', NULL),
(9, 'Emplacement Forêt 15', NULL),
(10, 'Eco-Lodge 01', NULL);
...
(1, 'Standard (2-4 pers)', 150, 15),
(2, 'Confort (6 pers)', 250, 25),
(3, 'Luxe (8 pers)', 400, 40);
...
--
ALTER TABLE `consommation`
  MODIFY `id_consommation` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=237;
