...
--
-- Hôte : db
-- Généré le : lun. 30 mars 2026 à 09:25
...
(252, 240, 4, 1, '2026-03-30 09:24:04');
...
(19, '2026-03-30 00:00:00', 123.45, 0, 29),
(20, '2026-03-30 00:00:00', 26883.6, 26883.6, 30);
...
(29, '2026-03-30 00:00:00', '2026-04-05 00:00:00', 1),
...
--
ALTER TABLE `consommation`
  MODIFY `id_consommation` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=253;
...
--
ALTER TABLE `historique_consommation`
  MODIFY `id_historique_consommation` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
