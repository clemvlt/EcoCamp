...
-- Généré le : jeu. 02 avr. 2026 à 13:24
...
(254, 26883.6, 3, 1, '2026-03-30 09:52:16');
...
(2, 'Mobil-home  02', 2, NULL),
(7, 'Mobil-home  03', 3, NULL),
(8, 'Mobil-home  04', 1, NULL),
(9, 'Mobil-home  05', 2, NULL),
(10, 'Mobil-home  06', 3, NULL);
...
(3, 't', '2026-03-31', '2026-04-05', NULL, 2);
...
--
ALTER TABLE `consommation`
  MODIFY `id_consommation` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=255;
